...
namespace JR_Terrain
{
	...
	bool Terrain::init(ID3D11Device* device, char* mapAddress,LPCSTR textureAddress)
	{
		...
		//Calcualte the normals for the terrain
	...
	bool Terrain::calculateNormals()
	{
		...
		//Create a temporary array to hild the un-normalized normal vectors
		normals = new Vector[(m_terrainHeight - 1)*(m_terrainWidth - 1)];
		if (!normals)
		{
			return false;
		}
