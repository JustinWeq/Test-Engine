...
namespace JR_Button
{
	...
	public:
		...
		bool init(const char* text, int x, int y, int width, int height, D3DXVECTOR4 foreColor, D3DXVECTOR4 backColor);
		...
		//setTextColor-- sets the new text color for the button
